# GENA &middot; [![PyPI](https://img.shields.io/pypi/v/gena)](https://pypi.org/project/gena) [![npm version](https://img.shields.io/npm/v/gena-app.svg?style=flat)](https://www.npmjs.com/package/gena-app)
